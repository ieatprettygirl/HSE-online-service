...
**Endpoint:** http://localhost:8080/api/profile/{id}  
**Параметры запроса:** "Id" пользователя в url, login, password.     
**Статус-коды HTTP:**  
...
**Параметры запроса:** Любое тело запроса (его отсутствие).  
**Статус-коды HTTP:**  
• 200 Created: Ресурс был успешно создан.  
• 400 Bad Request: Ошибка в запросе клиента.   
• 401 Unauthorized: Ошибка авторизации.   
...
**Endpoint:** http://localhost:8080/api/resume/{id}   
**Параметры запроса:** "Id" пользователя в url, education (об-ние), skills (навыки), birthday (дата рождения), full_name(ФИО), contact (контактная почта).    
**Статус-коды HTTP:**  
• 200 Created: Ресурс был успешно создан.  
• 400 Bad Request: Ошибка в запросе клиента.   
• 401 Unauthorized: Ошибка авторизации.   
